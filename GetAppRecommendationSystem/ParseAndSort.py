...
#     football_rating = user_activity_rating['Football babyyyyy'] 
    football_rating = user_activity_rating['Tel aviv football club']  
...
#     print("\n")
    ...
    for name in names:
        ...
        print ("Your recommended sub categories is: "+str(activity_names.loc[name]["sub_id"])+" Correlation: "+str(rating["Correlation"]))
